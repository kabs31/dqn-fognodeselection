...
# Compute the fitness for each individual in the initial population
fitness = np.zeros(Np)
for i in range(Np):
    fitness[i] = knapsack_problem(pop[i])
...
print()
print(childrens,len(childrens))

mutated_childrens = mutation(childrens,rm)
print()
print("mutated childrens")
print(mutated_childrens,len(mutated_childrens))
...
print("pso_childrens , gbest",pso_childrens,gbest)